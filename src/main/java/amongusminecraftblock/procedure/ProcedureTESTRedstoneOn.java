package amongusminecraftblock.procedure;
...
public class ProcedureTESTRedstoneOn extends ElementsAmongusminecraftblockMod.ModElement {
	public ProcedureTESTRedstoneOn(ElementsAmongusminecraftblockMod instance) {
		super(instance, 79);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		world.playSound((EntityPlayer) null, x, y, z, (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
				.getObject(new ResourceLocation("amongusminecraftblock:electric")), SoundCategory.NEUTRAL, (float) 10, (float) 1);
	}
}
